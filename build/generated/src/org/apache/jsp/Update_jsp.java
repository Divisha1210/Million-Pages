...
public final class Update_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("    padding: 10px;width: 80%; float:left\">\n");
      out.write("             ");
  ...
  private boolean _jspx_meth_t_form_0(PageContext _jspx_page_context)
    ...
    _jspx_th_t_form_0.setAction("/update");
    int _jspx_eval_t_form_0 = _jspx_th_t_form_0.doStartTag();
    if (_jspx_eval_t_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\n");
        out.write("           <h1><u>Change password?</u></h1><br>\n");
        out.write("        <br>\n");
        out.write("        <h3>   <label for=\"cpass\">Enter your username:</label> <input type=\"text\" name=\"user\" size=\"20\"/><br>\n");
        out.write("        <br><br><label for=\"cpass\">  Enter your current password :</label><input type=\"password\" name=\"opass\" size=\"20\"/><br>\n");
        out.write("          <br><br><label for=\"opass\">Enter your new password :</label><input type=\"password\" name=\"newpass\" size=\"20\"/>\n");
        out.write("          <br><br></h3>&nbsp;&nbsp;&nbsp;&nbsp;\n");
        out.write("        &nbsp;&nbsp;&nbsp;&nbsp;\n");
        out.write("        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\n");
        out.write("        &nbsp;&nbsp;&nbsp;&nbsp;\n");
        out.write("        &nbsp;&nbsp;&nbsp;\n");
        out.write("        <input type=\"submit\" name=\"t1\" value=\"Update\"/><br><br>\n");
        out.write("      &nbsp;&nbsp;&nbsp;&nbsp;\n");
        out.write("        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\n");
        out.write("        ");
